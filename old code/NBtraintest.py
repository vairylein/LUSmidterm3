...
ikea_en = "./t4e.corpora.tokenised/1.ikea/ikea.corpus.tokenised.validation.questions.txt"
ikea_it = "./t4e.corpora.tokenised/3.it.ikea/ikea.corpus.it.tokenised.validation.questions.txt"
ig = "./t4e.corpora.tokenised/0.ig1/ig1.corpus.tokenised.validation.questions.txt"
